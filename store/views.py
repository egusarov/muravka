...
def robots_txt(request):
    lines = [
        "User-agent: *",
        "Disallow: /accounts/",
        "Disallow: /ru/accounts/",
        "Disallow: /admin/",
        "Disallow: /store/cart/",
        "Disallow: /ru/store/cart/",
        "Disallow: /store/cart/add/",
        "Disallow: /ru/store/cart/add/",
        "Disallow: /store/cart/remove/",
        "Disallow: /ru/store/cart/remove/",
        "Disallow: /store/api/",
        "Disallow: /ru/store/api/",
        "Disallow: /store/order/create/",
        "Disallow: /ru/store/order/create/",
        "",
